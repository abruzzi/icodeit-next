...
summary: "Congratulations! You've successfully set up your development environment, which is an excellent initial achievement."
leading: "In next chapter, we'll focus on the HTML and CSS fundamental knowledge."
---
