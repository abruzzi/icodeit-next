...
description: "This book is all about converting beautiful designs into real-world websites. It includes three implementations of three different designs, and I'll walk you through all the details you need in pure HTML and CSS. From modern web development workflow and tools to CSS layouts and semantic HTML, from responsive design to design principles, it has every technique you may need for a design-to-page conversion."
