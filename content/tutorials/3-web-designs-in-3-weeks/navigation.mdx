...
description: "In this section, we will delve into the basics of HTML and CSS to create a functional and visually appealing navigation bar for our website. You'll learn how to structure your navigation bar in HTML and style it effectively with CSS, including an introduction to the Flexbox layout model."
date: 2023-12-22T17:46:12+11:00
tutorialId: "3-web-designs-in-3-weeks"
prev: "html-and-css"
next: "hero-banner"
highlights:
  - Understanding the fundamental HTML structure for a navigation bar.
  - Applying CSS styling for a professional and sleek navigation bar appearance.
  - An introduction to Flexbox for responsive layout design.
summary: "Great job on completing this chapter! You now have a well-designed navigation bar, setting a solid foundation for your website's layout."
leading: "Next up, we'll move onto the 'Hero Banner' section, where we'll apply our HTML and CSS skills to create an engaging and visually striking first impression for our website."
---
...
We can use `flex` layout to override this default behaviour. `flex` one of the layout mechanism in CSS. I'm not going to cover all `flex` properties here (because that is almost a book in itself), and we will only cover a few common ones here.
...
<Quiz
  question={"Which CSS property aligns items horizontally in a Flex container?"}
  options={[
    {
      label: "align-items",
      value: "align-items",
    ...
    },
    {
      ...
      description: "Aligns items along the main axis (horizontally for a row)."
    },
    {
  ...
  hint={"Think about how items are arranged within a flex container along its main axis."}
  explanation={
    "'justify-content' is the correct answer. It aligns flex items along the main axis of the flex container, which is horizontal when the flex direction is a row. This property is crucial for spacing and aligning items horizontally within a navigation bar."
  }
/>
