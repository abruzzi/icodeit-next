...
next: "hero-banner"
highlights:
  - How to Deconstruct a mockup?
  - Flex layout basic
summary: "Well done! You've got the necessary HTML and CSS knowledge to start your real development journey now."
leading: "In the upcoming chapter, we'll start with the top section of the page - navigation, and we wil surely have a lot of fun there."
---
