...
next: "recent-news"
highlights:
  - Advanced usage of flex layout
  - Position relative and absolute
summary: "Well done! You have finished 2 third of the project, keep it up."
leading: "In the next chapter, we will thoroughly explore the Recent News section, focusing on utilizing the flex layout for the positioning of multiple items."
---
