---
order: 3
title: "Static Page Implementation"
description: "Chapter 3 focuses on developing a static 'Quote of the Day' app. It guides through initializing a Node.js project, creating directories, and working with basic Shell commands. The chapter also introduces the `http-server` for local testing and covers the creation of the first static version of the app, including HTML and CSS implementation."
date: 2023-07-03T17:46:12+11:00
tutorialId: "from-commit-to-deployment"
next: "ch4"
highlights:
  - Creating and initializing a Node.js project.
  - Basic Shell command usage and project directory setup.
  - Introduction to using `http-server` for local development.
leading: "Next, we will delve into using React for extending the app, focusing on build scripts and further project development."
summary: "With a static version of the 'Quote of the Day' app up and running, you've taken a significant step in practical development. Ready to enhance it further in the next chapter!"
---
...
![npm test](/tutorials/from-commit-to-deployment/ch3/npm-test.png)
...
![npm start](/tutorials/from-commit-to-deployment/ch3/npm-start.png)
...
![Running in localhost](/tutorials/from-commit-to-deployment/ch3/localhost.png)
