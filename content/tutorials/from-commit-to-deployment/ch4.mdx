---
order: 4
title: "Convert to React Application"
description: "Chapter 4 transitions the 'Quote of the Day' app into a React application. It covers installing React, setting up a basic React structure, and introduces esbuild for compiling JSX into browser-readable JavaScript. The chapter also includes the implementation of a new feature, where clicking a button displays a new quote."
date: 2023-07-04T17:46:12+11:00
tutorialId: "from-commit-to-deployment"
next: "ch5"
highlights:
  - Introduction to React and its integration into the project.
  - Utilizing esbuild for JSX compilation and bundling.
  - Adding interactive features using React.
leading: "Having built a React-based interface, the next step will involve enhancing the app's functionality and exploring more complex development aspects."
summary: "With React integrated and the app's functionality expanded, you've made significant progress. The journey continues as we delve into more advanced development techniques."
---
...
![missed css](/tutorials/from-commit-to-deployment/ch4/missed-css.png)
...
![npm build](/tutorials/from-commit-to-deployment/ch4/npm-build.png)
...
![npm watch](/tutorials/from-commit-to-deployment/ch4/npm-watch.png)
...
![Running in localhost](/tutorials/from-commit-to-deployment/ch4/fixed.png)
