...
cover: "/posts//posts/images/modularizing-react-apps/headless-component-pattern/headless-component.png"
---

<InfoBox>
  *This article was originally published on [MartinFowler.com](https://martinfowler.com/articles/modularizing-react-apps.html)*
</InfoBox>
...
![Single component application](/posts/images/modularizing-react-apps/evolution-1.png)
...
![Multiple component](/posts/images/modularizing-react-apps/evolution-2.png)
...
![Hooks](/posts/images/modularizing-react-apps/evolution-3.png)
...
![Domain Object](/posts/images/modularizing-react-apps/evolution-4.png)
...
![Layers](/posts/images/modularizing-react-apps/evolution-5.png)
...
![payment methods](/posts/images/modularizing-react-apps/payment-methods.png)
...
![Payment code illustration](/posts/images/modularizing-react-apps/payment-original-illustration.png)
...
```tsx title="usePaymentMethods.ts"
...
```tsx title="usePaymentMethods.ts" {2-6}
if (methods.length > 0) {
  const extended: LocalPaymentMethod[] = methods.map((method) => ({
    provider: method.name,
    label: `Pay with ${method.name}`,
...
![refactoring](/posts/images/modularizing-react-apps/refactoring-1.png)
...
![round up](/posts/images/modularizing-react-apps/round-up.png)
...
```tsx title="Payment.tsx" {3} "useRoundUp"
const Payment = ({ amount }: { amount: number }) => {
  //...
...
![refactoring](/posts/images/modularizing-react-apps/refactoring-2.png)
...
<InfoBox>
  Shotgun surgery is an antipattern in software development which occurs when a developer adds features to an application codebase which span a multiplicity of implementors or implementations in a single change. This is common practice in many programming scenarios, as a great amount of programming effort is usually expended on adding new features to increase the value of programming assets. As a consequence, these new features may require adding code in several places simultaneously where the code itself looks very similar and may only have slight variations...
  --[wikipedia](https://en.wikipedia.org/wiki/Shotgun_surgery)
</InfoBox>

![shotgun surgery](/posts/images/modularizing-react-apps/shotgun-surgery.png)
...
![strategy pattern](/posts/images/modularizing-react-apps/strategy-pattern.png)
...
![refactoring](/posts/images/modularizing-react-apps/refactoring-3.png)
