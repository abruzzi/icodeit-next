  ...
  return (
    <div className="flex flex-col items-center space-y-4 py-16 text-lg leading-normal sm:flex-row sm:text-left sm:items-center sm:space-y-0 sm:space-x-4">
      <div className={`flex-1 text-base`}>
        ...
        <h1 className={`text-slate-900 text-3xl md:text-6xl tracking-normal dark:text-white ${inter.className}`}>
        ...
        <a
          ...
          target="_blank"
          className={`w-full md:w-40 text-center inline-block mt-2 text-lg uppercase tracking-wide border-2 px-6 py-2 rounded-full bg-gradient-to-br from-brand to-indigo-400 text-transparent bg-clip-text hover:from-purple-500 hover:to-pink-500 saturate-80 hover:saturate-100 hover:shadow-lg transition-all duration-200 border-brand`}
        >
          Subscribe
        </a>
      </div>
